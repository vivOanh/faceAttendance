...
class Ui_MainWindow(object):
    ...
    def insert_data_in_tablewidget(self, tablewidget):
        ...
        sql_select_subject = "SELECT * FROM Hocphans;"
        self.result_subject = self.conn.execute(sql_select_subject)
        # print(self.result_subject.fetchall())
        self.num_acc = len(self.conn.execute(sql_select_subject).fetchall())

        self.tableWidget.setRowCount(self.num_acc)

        for index_row, data_row in enumerate(self.result_subject):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Mã học phần','Tên học phần', 'Số tín chỉ', 'Học kỳ dạy'])
        ...
        self.btn_thoat.setGeometry(QtCore.QRect(650, 310, 180, 40))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "QUẢN LÝ HỌC PHẦN"))
